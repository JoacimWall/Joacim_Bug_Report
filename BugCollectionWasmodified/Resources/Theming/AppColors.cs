...
namespace TietoEvry.Maui.Resources.Theming;
public static class AppColors
{
    ...
    //------------ Base Colors ----------------------------------//
    public static Color Primary800Color = Color.FromArgb("#FF675C");
    public static Color Primary500Color = Color.FromArgb("#FF675C");
    public static Color Primary400Color = Color.FromArgb("#FF675C");
    public static Color Primary200Color = Color.FromArgb("#FF675C");
    public static Color Primary100Color = Color.FromArgb("#FF675C");
    ...
    public static Color StatusbarBackgroundColor = Color.FromArgb("#ffffff");
